...
| RN-036 | Task 036 | `task-notes/RN-036-task036-hwp-hwpx-template-fidelity-selector-execution-bridge.md` | Deterministic selector plans and execution bridging for template-preserving HWP/HWPX generation | cloud contract package corrected / local implementation pending |

## Index Maintenance Rule

- 새 Task가 완료되면 해당 Task의 Research Note를 `task-notes/`에 추가한다.
- cloud-first/local-verify Task는 local verification 전까지 cloud package 상태로 기록할 수 있다.
