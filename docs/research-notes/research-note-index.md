...
| RN-035 | Task 035 | `task-notes/RN-035-task035-local-workspace-staged-output-controlled-promotion-boundary.md` | Controlled staged-output promotion boundary | implementation complete pending formal local verification |
