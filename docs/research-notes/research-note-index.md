...
| RN-036 | Task 036 | `task-notes/RN-036-task036-hwp-hwpx-template-fidelity-selector-execution-bridge.md` | Deterministic selector plans and execution bridging for template-preserving HWP/HWPX generation | offline JSZip vendor created / runtime validation pending |
